/// updated : 1667133573726
/// cases : 635378991
/// todayCases : 121533
/// deaths : 6593545
/// todayDeaths : 293
/// recovered : 614438546
/// todayRecovered : 146209
/// active : 14346900
/// critical : 36220
/// casesPerOneMillion : 81513
/// deathsPerOneMillion : 845.9
/// tests : 6784241867
/// testsPerOneMillion : 853907.92
/// population : 7944933753
/// oneCasePerPeople : 0
/// oneDeathPerPeople : 0
/// oneTestPerPeople : 0
/// activePerOneMillion : 1805.79
/// recoveredPerOneMillion : 77337.15
/// criticalPerOneMillion : 4.56
/// affectedCountries : 230

class WorldStatsModal {
  WorldStatsModal({
      num? updated, 
      num? cases, 
      num? todayCases, 
  ...
  WorldStatsModal.fromJson(dynamic json) {
...
WorldStatsModal copyWith({  num? updated,
  num? cases,
  num? todayCases,
  num? deaths,
  num? todayDeaths,
  ...
  num? criticalPerOneMillion,
  num? affectedCountries,
}) => WorldStatsModal(  updated: updated ?? _updated,
  cases: cases ?? _cases,
